...
[Next Part](P007-features-that-define-python-p2)
...
String formatting is not limited to just introducing a variable in-between string, you can do a variety of fancy things while formating. Here is a [Python String Formatting Mini Language Quick Reference](https://gist.github.com/gauthamchettiar/fa3f32758616611bfecf941809fd598b){:target="_blank"} I made, in case you are curious.
...
![Negative Indexing](assets/img/P003/01.png)
...
If you felt these items were too basic for your tastes. I do have a [Part 2](P007-features-that-define-python-p2) that has slightly more useful features. Do check it out!
