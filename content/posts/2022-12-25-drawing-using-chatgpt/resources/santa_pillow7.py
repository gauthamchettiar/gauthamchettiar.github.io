...
# Draw Santa's smile
draw.arc((175, 200, 275, 220), 0, 180, fill='black')

# Draw Santa's wrinkles
draw.line((125, 125, 275, 275), fill='white', width=1)
draw.line((125, 275, 275, 125), fill='white', width=1)
